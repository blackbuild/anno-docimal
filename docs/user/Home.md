...
normalization, and duplicate-avoidance behavior are documented in the [usage guide](usage.md#runtime-groovydoc-interoperability).
...
[authoring guide](usage.md#ast-transformation-author-api) and
[supported API record](supported-api.md).
...
[source-projection guide](source-projection.md) specifies the policy and fidelity contract.

## Documentation map

- [Artifact, capture, plugin, Javadoc, and IDE integration guide](usage.md)
- [Supported API and implementation-only boundary](supported-api.md)
- [Advanced source-projection policy and fidelity](source-projection.md)
- [0.x-to-1.0 migration](migration/0.x-to-1.0-supported-api.md)
- [Module-path migration](migration/0.x-to-1.0-module-path.md)
- [Change history](https://github.com/blackbuild/anno-docimal/blob/master/CHANGES.md)
...
See the [module-path migration notes](migration/0.x-to-1.0-module-path.md) for named consumers.
