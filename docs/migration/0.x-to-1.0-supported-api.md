...
that depended on collection scanning or stale-output cleanup must keep that responsibility in its caller until it moves
to the supported Gradle task contract delivered by issue #35.
